...
if(!defined('CI_THEME_NAME')) 		define('CI_THEME_NAME', 'philoxenia');
...
if(!defined('CI_THEME_NICENAME')) 	define('CI_THEME_NICENAME', 'Philoxenia'); 
...
if(!defined('CI_DOCS'))				define('CI_DOCS', 'http://cssigniter.com/support/viewtopic.php?f=24&t=53');
...
if(!defined('CI_FORUM'))			define('CI_FORUM', 'http://cssigniter.com/support/viewforum.php?f=24');
