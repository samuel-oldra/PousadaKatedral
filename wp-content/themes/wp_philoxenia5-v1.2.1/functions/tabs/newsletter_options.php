...
<?php
	add_filter('ci_panel_tabs', 'ci_add_tab_newsletter_options', 50);
	...
	$ci_defaults['newsletter_heading'] = __('Sign up to our newsletter', 'ci_theme');
	$ci_defaults['newsletter_description'] = __('Get explosive offers straight to your inbox and win a free weekend stay', 'ci_theme');
...
<?php else: ?>
	<fieldset class="set">
		<p class="guide"><?php _e('You can set your newsletter options here. The newsletter form appears on your front page. You can set the wording of your newsletter form here. The header is displayed on top of the form, while the description is displayed on the left.', 'ci_theme'); ?></p>
		<?php ci_panel_input('newsletter_heading', __('Heading', 'ci_theme')); ?>
